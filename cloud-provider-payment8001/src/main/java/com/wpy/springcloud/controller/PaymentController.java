...
import com.wpy.springcloud.service.PaymentService;
...
public class PaymentController {
    ...
    public CommonResult getElementById(@PathVariable("id") Long id){
    ...
    public String paymentZiokin(){
        return "hi, i'am paymentzipkin server fall back, welcom to springcloud";
    }
